    ...
    <section className="w-full py-10 px-4 sm:px-6 lg:px-0">
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-end">
        ...
        "
          ...
          {/* Featured Card */}
          <div className="relative group overflow-hidden rounded-4xl lg:rounded-[2.5rem]  p-1 bg-(--primary-subtle)">
            ...
            <div className="relative p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
                <div className="self-start sm:self-auto p-4  rounded-2xl shadow-inner border border-(--card-border)">
                  <img
                    src={featured.logo}
                    alt={featured.school}
                ...
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="px-3 py-1 bg-(--secondary) text-[10px] font-bold uppercase tracking-widest rounded-full">
                      {t("latest")}
                    </span>
              ...
              <p className="mt-8 sm:mt-10 text-base sm:text-lg leading-relaxed border-l-4 border-indigo-500 pl-6 sm:pl-8 italic">
                "{featured.desc}"
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
            {rest?.map((edu, i) => (
              <div
                key={i}
                className="group relative bg-(--glow-color) border border-(--card-border) rounded-2xl sm:rounded-3xl p-5 hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-(--secondary) leading-tight group-hover:text-indigo-600 transition-colors">
                    {edu.degree}
                  </h3>

                  <p className="font-medium mt-1 mb-4 sm:mb-6 text-sm sm:text-base">
                    {edu.school}
                  </p>

                  <p className=" leading-relaxed text-sm">{edu.desc}</p>
                </div>
