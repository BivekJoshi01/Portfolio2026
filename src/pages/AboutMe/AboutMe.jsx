      ...
      <div className="flex items-center gap-10">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-6">
            ...
            ideas to life through code and constantly learning new technologies
            to improve my craft.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 text-gray-700 text-base">
            <div className="flex items-center gap-2">
              <span className="text-indigo-500 text-xl">⚡</span> React &
              Tailwind
            </div>
            <div className="flex items-center gap-2">
              <span className="text-indigo-500 text-xl">⚡</span> JavaScript /
              TypeScript
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-indigo-500 text-xl">⚡</span> API
              Integration
            </div>
          </div>
